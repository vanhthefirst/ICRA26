"""
Sketch-Prompted VLA validation set — LIBERO-OBJECT builder (needs the libero env).
...
full 38-scene run into outputs/validation_set_object/.
    ...
    python scripts/build_validation_set_object.py 2>&1 | tee outputs/validation_set_object/build_log.txt
"""
...
{n} scenes. Generated by `scripts/build_validation_set_object.py` (SMOKE={SMOKE}).
...
conda activate libero
cd /mnt/c/Users/Admin/sketch_prompted_vla
python scripts/build_validation_set_object.py
```
"""
