"""
DrawVLA validation set — LIBERO-OBJECT builder (run in WSL2, libero env).
...
SMOKE = False
OUT_ROOT = "/mnt/c/Users/Admin/sketch_vla/outputs/validation_set_object"
IMG_H = IMG_W = 128
CAMERA = "agentview"
...
def write_datasheet(manifest, fails):
    ...
    md = f"""# DrawVLA validation set — LIBERO-**Object** suite

{n} scenes. Generated by `scripts/build_validation_set_object_wsl.py` (SMOKE={SMOKE}).
Companion to the Spatial set in `outputs/validation_set_hardened/`.
