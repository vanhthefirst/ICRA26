...
\begin{quote}\small
\code{python scripts/build\_validation\_set\_spatial\_wsl.py} \\
\code{python scripts/build\_validation\_set\_object\_wsl.py} \\
\code{python scripts/build\_validation\_set\_goal\_wsl.py} \\
