...
38 scenes. Generated by `scripts/build_validation_set_object.py` (SMOKE=False).
...
| referential | 12 | 2-5 | 1 | many-to-one — which object |
...
- **Tier is multiplicity, not occlusion.** `agentview` looks down at the
